...
namespace SortingAlgorithmsLibTests
{
    ...
    public class QuickSortTests
    {
        ...
        [TestMethod]
        public void QuickSort_DateTimeIListSorted_SortedItemsReturned()
        {
            // Arrange
            //YYYY, M, D, H, M, S
            ...
            // Act
            actualItems = SortingAlgorithms.SortingAlgorithms.QuickSort(actualItems) as DateTime[];

            // Assert
            CollectionAssert.AreEqual(expectedItems, actualItems);
        }
        [TestMethod]
        public void QuickSort_DateTimeIListOneSwap_SortedItemsReturned()
        {
            // Arrange
            //YYYY, M, D, H, M, S
            DateTime[] actualItems = new DateTime[] {
        ...
        [TestMethod]
        public void QuickSort_DateTimeRandomIList_SortedItemsReturned()
        {
            // Arrange
            //YYYY, M, D, H, M, S
            DateTime[] actualItems = new DateTime[] {
        ...
        [TestMethod]
        public void QuickSort_EmptyDateTimeIList_SortedItemsReturned()
        {
            // Arrange
            //YYYY, M, D, H, M, S
            DateTime[] actualItems = new DateTime[] { };
        ...
        [TestMethod]
        public void QuickSort_DateTimeIListWithTwoItems_SortedItemsReturned()
        {
            // Arrange
            //YYYY, M, D, H, M, S
